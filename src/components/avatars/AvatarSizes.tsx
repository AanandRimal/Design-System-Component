export const avatarSizes: Record<number, { base: number; status: number; dotplacement:number}> = {
    ...
    36: {  base: 36,status:10,dotplacement:26 },
    40: {  base: 40,status:10,dotplacement:30 },
    48: {  base: 48,status:12,dotplacement:36 },
    64: {  base: 64,status:16,dotplacement:47 },
    80: {  base: 80,status:20,dotplacement:58 },
    120:{  base: 120,status:26,dotplacement:90 },
  };
