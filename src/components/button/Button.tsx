...
const Button: React.FC<ButtonProps> = ({
  ...
  const buttonSizeKey = Sizes.hasOwnProperty(Customsize as keyof typeof Sizes) // if given size has size mapped then it takes else it defualt to size 32 
  ...
  const finalPaddingY = isSocialType ? socialPadding?.paddingY : buttonSizeKey?.paddingY;
  const finalPaddingX = isSocialType ? socialPadding?.paddingX : buttonSizeKey?.paddingX;
