  ...
  return (
    <ConfigProvider
      theme={{
        ...
        components: {
          Alert: {
            colorInfo: themeType === "neutral" ? currentTheme.text.t3Subtitle:themeTypeKey.default,
            colorInfoHover:  themeType === "neutral" ? currentTheme.fill.f1: themeTypeKey.hover,
            colorInfoActive:  themeType === "neutral" ? currentTheme.text.t3Subtitle:themeTypeKey.default,
            colorInfoBg: stroke? "none" : themeType === "neutral" ? currentTheme.fill.f2: themeTypeKey.focus,
